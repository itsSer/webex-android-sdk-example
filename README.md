...
3. Add the following dependency in module level Gradle file and press sync-now
   ```
   implementation files('libs/UCF-SDK-v3.0.0.aar')
   ```
### Option 2
  ...
  2. Add the `webex-android-sdk` library as a dependency for your app in the `build.gradle` file:
        ...
        ```
        dependencies { 
            implementation 'com.ciscowebex:androidsdk:3.0.0-SNAPSHOT@aar'
        }
        ```
   
## Usage
 
For example see [README.md](https://github.com/webex/webex-android-sdk/blob/v3-beta/README.md)

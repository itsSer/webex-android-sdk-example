...
class KitchenSinkFCMService : FirebaseMessagingService() {
    ...
    private fun buildCallNotification(data: FCMPushModel) {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            ...
            Log.d(TAG, "CallInfo ${callInfo.callId} title ${callInfo.title}")
    ...
    private fun sendCallNotification(callInfo: Call) {
        ...
        intent.putExtra(Constants.Intent.CALL_ID, callInfo.callId)
        ...
        val notificationBuilder = NotificationCompat.Builder(this, channelId)
                ...
                .setContentTitle("${callInfo.title} is calling")
    ...
    private fun showToast() {
        ...
        handler.post {
            Toast.makeText(applicationContext, "FCM msg received!!!", Toast.LENGTH_SHORT).show()
        }
    }

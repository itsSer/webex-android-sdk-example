    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        DataBindingUtil.setContentView<ActivityOauthBinding>(this, R.layout.activity_oauth)
                ...
                .apply {
                    ...
                    loginViewModel.isAuthorized.observe(this@OAuthLoginActivity, Observer { isAuthorized ->
                    ...
                    loginViewModel.isAuthorizedCached.observe(this@OAuthLoginActivity, Observer { isAuthorizedCached ->
                        progressLayout.visibility = View.GONE
